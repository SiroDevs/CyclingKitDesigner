...
export const SHORTS_PARTS: KitPart[] = [
  { id: 'shorts_main', label: 'Main Body', defaultColor: '#1a1a1a' },
  { id: 'shorts_straps', label: 'Straps', defaultColor: '#1a1a1a' },
  { id: 'shorts_pad', label: 'Chamois Pad', defaultColor: '#2a2a2a' },
  { id: 'shorts_side', label: 'Side Panels', defaultColor: '#1a1a1a' },
]
